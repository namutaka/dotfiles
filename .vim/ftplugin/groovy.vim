...
if !hasmapto("<SID>ShowHelp()", "n")
	nmap <buffer><unique><silent> <C-F2> :call <SID>ShowHelp()<CR>
endif
if !hasmapto("<SID>RunPrompt()", "n")
	nmap <buffer><unique><silent> <C-F3> :call <SID>RunPrompt()<CR>
endif
if !hasmapto("<SID>RunNoPrompt()")
	nmap <buffer><unique><silent> <C-F4> :call <SID>RunNoPrompt()<CR>
endif
if !hasmapto("<SID>CompilePrompt()")
	nmap <buffer><unique><silent> <C-F5> :call <SID>CompilePrompt()<CR>
endif
if !hasmapto("<SID>CompileNoPrompt()")
	nmap <buffer><unique><silent> <C-F6> :call <SID>CompileNoPrompt()<CR>
endif
